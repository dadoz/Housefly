...
public class HouseRetrofitTest {
    ...
    public void setUp() throws Exception {
        ...
        ((HouseflyApplication) mRule.getActivity().getApplication()).setOwner("dadoz");
        ((HouseflyApplication) mRule.getActivity().getApplication()).setRepo("SelectCardViewPrototype");

        mRule.getActivity().startActivity(new Intent(mRule.getActivity(), HouseListActivity.class));
    }
